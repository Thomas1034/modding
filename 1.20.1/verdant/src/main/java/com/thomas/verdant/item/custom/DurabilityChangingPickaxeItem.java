...
public class DurabilityChangingPickaxeItem extends PickaxeItem {

	private final int changesEvery;
	private final int changesBy;

	public DurabilityChangingPickaxeItem(Tier tier, int i, float f, int changesBy, int changesEvery,
