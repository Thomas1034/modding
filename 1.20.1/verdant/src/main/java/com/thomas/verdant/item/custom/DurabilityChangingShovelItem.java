...
public class DurabilityChangingShovelItem extends ShovelItem {

	private final int changesEvery;
	private final int changesBy;

	public DurabilityChangingShovelItem(Tier tier, float i, float f, int changesBy, int changesEvery,
