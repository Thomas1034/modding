...
import com.thomas.verdant.woodset.WoodSetClient;
...
public class Verdant {
	...
	public static class ClientModEvents {
		public static final WoodSetClient VERDANT_HEARTWOOD_CLIENT = new WoodSetClient(ModBlocks.VERDANT_HEARTWOOD);
		public static final WoodSetClient VERDANT_CLIENT = new WoodSetClient(ModBlocks.VERDANT);
