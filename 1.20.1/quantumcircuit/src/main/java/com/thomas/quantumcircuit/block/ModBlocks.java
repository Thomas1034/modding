...
import com.thomas.quantumcircuit.block.custom.QuantumWireBlock;
...
public class ModBlocks {
	...
	public static final RegistryObject<Block> QUANTUM_CHANNEL = registerBlock("quantum_channel",
			() -> new QuantumWireBlock(BlockBehaviour.Properties.copy(Blocks.REDSTONE_WIRE).sound(SoundType.ANCIENT_DEBRIS)
