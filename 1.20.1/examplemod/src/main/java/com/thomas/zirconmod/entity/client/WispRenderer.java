...
public class WispRenderer extends MobRenderer<WispEntity, WispModel<WispEntity>> {
	...
	public WispRenderer(EntityRendererProvider.Context context) {
		...
		super(context, new WispModel<>(context.bakeLayer(ModModelLayers.WISP_LAYER)), 0.25F);
	}
	...
	public ResourceLocation getTextureLocation(WispEntity p_115974_) {
		return new ResourceLocation(ZirconMod.MOD_ID, "textures/entity/wisp.png");
	}
}