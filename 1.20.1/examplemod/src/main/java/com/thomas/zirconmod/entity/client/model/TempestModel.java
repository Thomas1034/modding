...
public class TempestModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tempest = partdefinition.addOrReplaceChild("tempest", CubeListBuilder.create(),
				PartPose.offset(0.0F, 20.0F, 0.0F));

		PartDefinition head = tempest.addOrReplaceChild("head", CubeListBuilder.create().texOffs(56, 2).addBox(-1.0F,
				-13.0F, 10.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -9.0F, -11.0F));

		PartDefinition body = tempest.addOrReplaceChild("body", CubeListBuilder.create(),
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		this.animateWalk(ModAnimationDefinitions.TEMPEST_WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
		this.animate(((TempestEntity) entity).idleAnimationState, ModAnimationDefinitions.TEMPEST_IDLE, ageInTicks, 1f);
	}
