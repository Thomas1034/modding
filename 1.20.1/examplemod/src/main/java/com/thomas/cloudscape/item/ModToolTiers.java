...
public class ModToolTiers {
	...
	public static final Tier ZIRCONIUM = TierSortingRegistry.registerTier(
			...
			new ResourceLocation(Cloudscape.MOD_ID, "zirconium"), List.of(Tiers.WOOD, Tiers.STONE, Tiers.GOLD, Tiers.IRON),
			List.of(Tiers.DIAMOND, Tiers.NETHERITE));

	public static final Tier COPPER = TierSortingRegistry.registerTier(
			new ForgeTier(1, 160, 5.5F, 1.5F, 17, ModTags.Blocks.NEEDS_COPPER_TOOL,
					() -> Ingredient.of(Items.COPPER_INGOT)),
			new ResourceLocation(Cloudscape.MOD_ID, "copper"), List.of(Tiers.WOOD, Tiers.STONE),
