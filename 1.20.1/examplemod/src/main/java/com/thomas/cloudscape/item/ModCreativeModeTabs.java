	...
	public static final RegistryObject<CreativeModeTab> ZIRCONMOD_BLOCKS = CREATIVE_MODE_TABS.register(
			...
			() -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.ZIRCON_BLOCK.get()))
					...
					.displayItems((pParameters, pOutput) -> {
						...
						pOutput.accept(ModBlocks.RAIN_CLOUD.get());
						pOutput.accept(ModBlocks.RAIN_CLOUD_BRICKS.get());
						pOutput.accept(ModBlocks.RAIN_CLOUD_BRICK_SLAB.get());
						pOutput.accept(ModBlocks.RAIN_CLOUD_BRICK_STAIRS.get());
						pOutput.accept(ModBlocks.RAIN_CLOUD_BRICK_WALL.get());
						pOutput.accept(ModBlocks.RAIN_CLOUD_BRICK_PILLAR.get());
						pOutput.accept(ModBlocks.CHISELED_RAIN_CLOUD_BRICKS.get());
