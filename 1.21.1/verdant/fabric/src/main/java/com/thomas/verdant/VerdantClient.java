...
public class VerdantClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        markCutout(BlockRegistry.DIRT_COAL_ORE, BlockRegistry.DIRT_COPPER_ORE, BlockRegistry.DIRT_DIAMOND_ORE,
                ...
                BlockRegistry.VERDANT_ROOTED_CLAY, BlockRegistry.VERDANT_GRASS_CLAY, BlockRegistry.STRANGLER_VINE, BlockRegistry.STRANGLER_LEAVES, BlockRegistry.LEAFY_STRANGLER_VINE);
