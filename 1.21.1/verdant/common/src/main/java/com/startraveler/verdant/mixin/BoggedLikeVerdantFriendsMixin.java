...
public class BoggedLikeVerdantFriendsMixin {
    ...
    private NearestAttackableTargetGoal<@NotNull Player> verdant$makeBoggedLikeVerdantFriends(NearestAttackableTargetGoal<@NotNull Player> original) {
        BiFunction<TargetingConditions.Selector, TargetingConditions.Selector, TargetingConditions.Selector> mergeAnd = (selector1, selector2) -> selector2 == null ? selector1 : (livingEntity, serverLevel) -> selector1.test(
                livingEntity,
                serverLevel
