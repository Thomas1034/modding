...
public class RandomPatchFeature extends Feature<@NotNull RandomPatchConfiguration> {
    public RandomPatchFeature(final Codec<RandomPatchConfiguration> codec) {
        super(codec);
    }

    @Override
    public boolean place(final FeaturePlaceContext<@NotNull RandomPatchConfiguration> context) {
