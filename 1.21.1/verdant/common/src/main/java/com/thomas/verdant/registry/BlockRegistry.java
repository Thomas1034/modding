...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block, Block> DENSE_GRAVEL;
    ...
    static {
        ...
        DENSE_GRAVEL = registerBlockWithItem("dense_gravel", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.GRAVEL).pushReaction(PushReaction.DESTROY)));
        ...
        DIRT_REDSTONE_ORE = registerBlockWithItem("dirt_redstone_ore", () -> new RedStoneOreBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COARSE_DIRT)));
