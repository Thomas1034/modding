...
To start your experience with the Verdant Growth, you'll have to first find an **Overgrown Pyramid**. These are found in any jungle biome, and come in two variants. Both variants have four loot chests, one per corner. What you find in the center of the pyramid will vary. There are no traps in this structure.

<Asset width={1280} height={960} location="verdant:images/overgrown_pyramid" title="Overgrown Pyramid" />
