...
**Sparkling Starch** can be brewed in a potion stand into a **Thick Potion** to produce a **Potion of Colloid**; entities inflicted with this effect will be briefly slowed when they take damage. This can be very useful against faster or more evasive foes, and is deadly when combined with environmental hazards such as spikes.
