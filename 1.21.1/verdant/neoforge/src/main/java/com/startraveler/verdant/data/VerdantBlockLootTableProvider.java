...
public class VerdantBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.dropOther(BlockRegistry.TWISTED_ROPE_HOOK.get(), Blocks.TRIPWIRE_HOOK);
        ...
        this.add(
                ...
                this.createLeavesDrops(BlockRegistry.STRANGLER_LEAVES.get(), Blocks.VINE, NORMAL_LEAVES_SAPLING_CHANCES)
        );
        ...
        this.dropSelf(BlockRegistry.COPPER_SPIKES.get());
        this.dropSelf(BlockRegistry.IRON_SPIKES.get());
        this.dropSelf(BlockRegistry.GOLDEN_SPIKES.get());
        this.dropSelf(BlockRegistry.WOODEN_TRAP.get());
        this.dropSelf(BlockRegistry.COPPER_TRAP.get());
        this.dropSelf(BlockRegistry.IRON_TRAP.get());
        this.dropSelf(BlockRegistry.GOLDEN_TRAP.get());
        ...
        this.dropSelf(BlockRegistry.TWISTED_ROPE.get());
        ...
        this.add(
                BlockRegistry.BLASTING_BUNCH.get(),
                bombPileTableMaker.apply(BlockRegistry.BLASTING_BUNCH.get(), ItemRegistry.STABLE_BLASTING_BLOOM.get())
        );
        this.add(
                BlockRegistry.TERRACOTTA_BOMB_PILE.get(),
                bombPileTableMaker.apply(BlockRegistry.TERRACOTTA_BOMB_PILE.get(), ItemRegistry.TERRACOTTA_BOMB.get())
        );
        this.add(
                BlockRegistry.METAL_BOMB_PILE.get(),
                bombPileTableMaker.apply(BlockRegistry.METAL_BOMB_PILE.get(), ItemRegistry.METAL_BOMB.get())
        );
