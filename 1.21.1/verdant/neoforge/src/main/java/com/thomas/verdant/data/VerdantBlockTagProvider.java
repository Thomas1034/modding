...
public class VerdantBlockTagProvider extends BlockTagsProvider {
    public VerdantBlockTagProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, ExistingFileHelper existingFileHelper) {
...
//        this.tag(BlockTags.SWORD_EFFICIENT).add(BlockRegistry.STRANGLER_LEAVES.get(), BlockRegistry.THORNY_STRANGLER_LEAVES.get(),
//                BlockRegistry.POISON_IVY_STRANGLER_LEAVES.get(), BlockRegistry.THORN_BUSH.get(), BlockRegistry.BUSH.get(),
//                BlockRegistry.STRANGLER_TENDRIL.get(), BlockRegistry.STRANGLER_TENDRIL_PLANT.get(), BlockRegistry.POISON_IVY.get(),
...
//                BlockRegistry.BLACK_CANDLE_UBE_CAKE.get());
        ...
        // Leafy blocks
        this.tag(VerdantTags.Blocks.STRANGLER_LEAVES).add(/*BlockRegistry.WILTED_STRANGLER_LEAVES.get(),*/
                BlockRegistry.STRANGLER_LEAVES.get(), /*BlockRegistry.THORNY_STRANGLER_LEAVES.get(),
                BlockRegistry.POISON_IVY_STRANGLER_LEAVES.get(),*/ BlockRegistry.LEAFY_STRANGLER_VINE.get());
        this.tag(BlockTags.LEAVES).addTag(VerdantTags.Blocks.STRANGLER_LEAVES);
        // Vines
